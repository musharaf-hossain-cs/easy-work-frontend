...
function AddUserForm(props) {
 ...
 const { designations, setChosenMembers, setAddMore, addMember, index, selectedMembers } = props;
 ...
 const chooseMember = (event, v) => {
  if (v !== null) {
   addMember(index, v.id, v.label, v.job_name);
 ...
 return (
  <Form className="row">
   ...
   {jobFetch && <SelectUser rows={members} />}
   {/* {jobFetch && (
